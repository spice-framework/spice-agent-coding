...
func TestGeneratedArchitectureProofContainsInspectableDirectCalls(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"internal/architectureproof/proof_bean.go",
		"internal/architectureproof/process_launcher_bean.go",
		"internal/architectureproof/architecture_proof_engine_bean.go",
