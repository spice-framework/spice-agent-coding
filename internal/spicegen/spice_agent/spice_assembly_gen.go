...
func NewApplicationWithOptions(ctx context.Context, options ApplicationOptions) (*Application, error) {
	...
	loggingScopes := []spicelogging.Scope{
		...
		{Module: "spice.unassigned:github.com/spice-framework/spice-agent-coding/internal/workspace"},
		{Module: "spice.unassigned:github.com/spice-framework/spice-agent-coding/internal/workspace", Component: "spice:symbol:v1|type|64:github.com/spice-framework/spice-agent-coding/internal/workspace|0:|10:Properties"},
