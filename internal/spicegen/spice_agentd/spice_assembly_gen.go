...
func NewApplicationWithOptions(ctx context.Context, options ApplicationOptions) (*Application, error) {
	...
	loggingScopes := []spicelogging.Scope{
		...
		{Module: "github.com/spice-framework/spice-agent-coding/internal/daemoncommand"},
		...
		{Module: "github.com/spice-framework/spice-agent-coding/internal/processcontainment"},
